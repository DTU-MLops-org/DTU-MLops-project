...
* [ ] Create a FastAPI application that can do inference using your model (M22)                 (ANNA   )
* [ ] Deploy your model in GCP using either Functions or Run as the backend (M23)               (BLOCKED)
* [ ] Write API tests for your application and setup continues integration for these (M24)      (BLOCKED)
...
* [ ] Create a frontend for your API (M26)                                                      (MAKSYM )

### Week 3

* [!] Check how robust your model is towards data drifting (M27)                                                            (HELGA, JULIE)
* [!] Deploy to the cloud a drift detection API (M27)                                                                       (HELGA, JULIE)         
